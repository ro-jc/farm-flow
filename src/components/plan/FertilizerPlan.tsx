...
export const FertilizerPlan = () => {
  ...
  const sections = isOrganic ? [
    ...
    },
    {
      ...
      color: 'farm-organic',
      items: [
        { name: spicProducts.nano.nanoUrea.brand, composition: spicProducts.nano.nanoUrea.composition, qty: `${(500 * area / 1000).toFixed(1)} L`, application: language === 'en' ? 'Foliar spray at germination, tillering & 1 weekflowering' : 'கிளைப்பு & பூக்கும் நேரத்தில் இலை தெளிப்பு' },
